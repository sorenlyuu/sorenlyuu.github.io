...
document.addEventListener("DOMContentLoaded", () => {
    if (detectMob()) {
        alert('hi if ur on mobile id recommend using desktop site and zooming out the text alot cauze i havent really scaled down to mobile yet... or just use a pc / wait until i stop being lazy xd')
    }
